...
export function TodoInput({ addTask, theme }: TodoInputProps) {
  ...
  return (
    <View style={[
      theme === 'light' ? styles.inputContainer : styles.DarkInputContainer,
      Platform.OS === 'ios' ? styles.inputIOSShadow : styles.inputAndroidShadow]}
    >
      <TextInput 
        style={[theme === 'light' ? styles.input : styles.darkInput]} 
      ...
      <TouchableOpacity
        ...
        activeOpacity={0.7}
        style={[theme === 'light' ? styles.addButton : styles.darkAddButton]}
